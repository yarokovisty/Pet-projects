package org.yarokovisty.delivery.feature.login.presentation.viewmodel
...
import org.yarokovisty.delivery.feature.login.presentation.state.changeOtpCode
import org.yarokovisty.delivery.feature.login.presentation.state.changePhoneNumber
import org.yarokovisty.delivery.feature.login.presentation.state.clearOtpRetryTimer
import org.yarokovisty.delivery.feature.login.presentation.state.initial
import org.yarokovisty.delivery.feature.login.presentation.state.invalidFormatOtpCode
import org.yarokovisty.delivery.feature.login.presentation.state.invalidOtpCode
import org.yarokovisty.delivery.feature.login.presentation.state.invalidPhoneNumber
import org.yarokovisty.delivery.feature.login.presentation.state.showOtpInput
import org.yarokovisty.delivery.feature.login.presentation.state.tickOtpRetryTimer
import org.yarokovisty.delivery.feature.login.presentation.state.validOtpCode
import org.yarokovisty.delivery.feature.login.presentation.state.validPhoneNumber
import org.yarokovisty.delivery.feature.login.util.toSecondRounded
